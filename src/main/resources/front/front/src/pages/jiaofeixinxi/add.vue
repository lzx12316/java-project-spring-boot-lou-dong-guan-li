...
<div :style='{"width":"100%","padding":"20px 10%","margin":"20px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="时间" prop="shijian">
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="缴费类型" prop="jiaofeileixing">
            <el-select v-model="ruleForm.jiaofeileixing" placeholder="请选择缴费类型" :disabled=" false  ||ro.jiaofeileixing" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="费用" prop="feiyong">
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.jiaofeileixingOptions = "水费,电费,物业费".split(',')
