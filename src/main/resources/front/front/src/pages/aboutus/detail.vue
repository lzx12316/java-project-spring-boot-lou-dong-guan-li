		...
		<div class="attr" :style='{"borderColor":"#75664d","margin":"10px 2%","background":"#fff","flex":"1","borderWidth":"5px 0 0","display":"flex","width":"45%","position":"relative","borderStyle":"solid","order":"1"}'>
			...
			<div class="info" :style='{"background":"#fff","flex":"1"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('aboutus','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('aboutus','删除')" @click="delClick">删除</el-button>
