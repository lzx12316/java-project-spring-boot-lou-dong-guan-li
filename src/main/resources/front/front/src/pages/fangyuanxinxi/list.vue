...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"1px solid #C7C7C7","padding":"20px 10px 0","margin":"0 0 20px","alignItems":"center","background":"#fff","flexDirection":"row","display":"flex","width":"100%","height":"auto","order":"1"}'>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 5px 0","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>月租/元：</div>
        <el-input v-model="formSearch.yuezustart" placeholder="最小月租/元" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
        <el-input v-model="formSearch.yuezuend" placeholder="最大月租/元" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 5px 0","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>联系电话：</div>
	...
	<div class="list" :style='{"border":"1px solid #C7C7C7","width":"auto","margin":"0","background":"#fff","flex":"1","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"20px 10px 0","background":"#fff","height":"auto"}'>
			<div :style='{"border":"1px solid #E0E0E0","padding":"8px","margin":"0 1% 20px","background":"#ffff","display":"inline-block","width":"23%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#000","textAlign":"center"}' class="name ">{{item.fangyuanchengshi}}</div>
...
<script>
  export default {
    ...
    created() {
		...
		this.$http.get('option/fangyuanleixing/fangyuanleixing').then(res => {
			if (res.data.code == 0) {
				this.fangyuanleixingOptions = res.data.data;
				this.selectOptionsList.push({name:'房源类型',list:this.fangyuanleixingOptions,tableName: 'fangyuanleixing',check: -1})
			}
		});
      this.getFenlei();
      this.getList(1, '全部');
    ...
    methods: {
      ...
      getFenlei() {
		...
		this.feileiColumn = 'fangyuanleixing'
      },
      getList(page, fenlei, ref = '') {
        ...
        if(this.formSearch.yuezustart!='' && this.formSearch.yuezustart!=undefined ){
          searchWhere.yuezustart = this.formSearch.yuezustart
        }
        if(this.formSearch.yuezuend!='' && this.formSearch.yuezuend!=undefined){
          searchWhere.yuezuend = this.formSearch.yuezuend
        }
        ...
        if (this.curFenlei != '全部') searchWhere.fangyuanleixing = this.curFenlei;
