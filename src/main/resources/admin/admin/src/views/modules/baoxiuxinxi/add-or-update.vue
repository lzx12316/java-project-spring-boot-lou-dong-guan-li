	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="报修内容" prop="baoxiuneirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.baoxiuneirong" label="报修内容" prop="baoxiuneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"400px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.baoxiuneirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.baoxiuneirong = this.ruleForm.baoxiuneirong.replace(reg,'../../../springboot4y8k8m47/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
