  ...
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231101/a7c636f5b2a0455d8f08899ab6e08582.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"bottom center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
      <el-form :style='{"border":"0","padding":"80px 40px","boxShadow":"none","margin":"5% 4% 0 0","borderRadius":"10px 10px","background":"url(http://codegen.caihongy.cn/20231101/82632a780f5047e18aed0e5f9fbecdf1.png)","width":"38%","backgroundSize":"100% 100%","position":"relative","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"auto","zIndex":"111"}'>
        <div v-if="true" :style='{"margin":"0 auto 30px","color":"#654B3C","textAlign":"left","width":"80%","lineHeight":"44px","fontSize":"24px","textShadow":"none","fontWeight":"bold"}' class="title-container">基于spring boot的楼栋管理系统登录</div>
        ...
        <div :style='{"boxShadow":"none","padding":"0 0","margin":"20px auto 0","alignItems":"flex-start","borderRadius":"0 0 10px 10px","background":"#fff","flexDirection":"column","display":"flex","width":"80%","position":"relative","zIndex":"-1"}'>
          ...
          <el-button :style='{"border":"1px solid #9B9B9B","cursor":"pointer","padding":"0 24px","margin":"0 10px 10px","color":"#9B9B9B","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"15px","height":"44px","order":"1"}' type="primary" @click="register('erjiguanliyuan')" class="register">注册二级管理员</el-button>
        </div>
      </el-form>
